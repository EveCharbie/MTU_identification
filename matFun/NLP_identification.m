function [param_opt,cost] = NLP_identification(known_parameters_num,muscle_tendon_parameters_num,unknown_parameters,casadiFun,Data,opts,intialGuess)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
w = { w{:}, UP};
w0 =  [w0; intialGuess' ]; % intial guess
lbw = [lbw; muscle_tendon_parameters_num' * 0.05]; % lower bound of variable
